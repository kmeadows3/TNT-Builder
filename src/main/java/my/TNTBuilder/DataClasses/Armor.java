...
public class Armor extends InventoryItem{
    ...
    public Armor(String type, int cost, String specialRules, List<ItemTrait> itemTraits, String rarity, boolean isRelic, int meleeDefenseBonus, int rangedDefenseBonus, boolean isShield, int cost2Wounds, int cost3Wounds) {
